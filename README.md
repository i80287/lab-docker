...
с `Dockerfile`, и при перезапуске проекта (шаги 1-3) будет запущен `Jupyterhub` сервер, <br />
и пользователю `admin` будут скопированы все ноутбуки, которые вы переместили в папку проекта
