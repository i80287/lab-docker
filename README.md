...
с `Dockerfile`, и при перезапуске проекта (шаги 1-3) все ноутбуки, которые вы переместили в папку <br />
проекта, будут скопированы в папку `/jupyterhub_lab` внутри файловой системы контейнера
