...
**3.** В браузере перейдите по ссылке http://127.0.0.1:8088/ <br />
Перед вами откроется окно входа в аккаунт в системе `Jupyterhub` <br />
Введите пару логин-пароль `admin` - `admin` <br />
Для вас будет создан сервер, на который вы сможете загружать свои файлы <br />
Т.к. данные пользователя `admin` хранятся в `/home/admin`, то загруженные <br />
вами файлы не будут потеряны даже при удалении контейнера
