...
Т.к. данные пользователя `admin` хранятся в `/home/admin`, то загруженные вами файлы <br />
не будут потеряны даже при удалении контейнера (доступ к ним можно получить через `volume`)
